 ...
 * 全局异常处理类
 * @author chenyi
 * @className ChenYiChenYiMallException
 * @date 2022/5/7 20:16
 */
@Slf4j
@RestControllerAdvice
public class GlobalChenYiMallException {

    @ExceptionHandler(value = ChenYiMallException.class)
    public R chenYiChenYiMallException(ChenYiMallException e) {
