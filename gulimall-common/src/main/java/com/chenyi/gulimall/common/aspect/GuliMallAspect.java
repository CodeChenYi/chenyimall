package com.chenyi.gulimall.common.aspect;

import com.chenyi.gulimall.common.annotation.LogAnnotation;
import com.chenyi.gulimall.common.enums.ResultEnum;
import com.chenyi.gulimall.common.exception.GuliMallException;
import com.chenyi.gulimall.common.utils.IPUtils;
import com.chenyi.gulimall.common.utils.JSONUtils;
import com.chenyi.gulimall.common.utils.ServletUtils;
 ...
 * 日志切面类
 * @author chenyi
 * @className GuliMallAspect
 * @date 2022/5/7 23:24
 */
@Slf4j
@Component
@Aspect
public class GuliMallAspect {

    @Pointcut("@annotation(com.chenyi.gulimall.common.annotation.LogAnnotation)")
    ...
    private void handleLog(JoinPoint joinPoint, Exception e, Object jsonResult) {
        ...
        if (e != null) {
            ...
            if (e instanceof GuliMallException) {
                GuliMallException exception = (GuliMallException) e;
